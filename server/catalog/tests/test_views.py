...
class ViewTests(APITestCase):
    ...
    def test_views_001_test_empty_query_return_anything(self):
    ...
    def test_views_002_test_query_matches_variety(self):
    ...
    def test_views_003_test_query_matches_winery(self):
    ...
    def test_views_004_test_query_matches_description(self):
    ...
    def test_views_005_test_can_filter_on_country(self):
    ...
    def test_views_006_test_can_filter_on_points(self):
        response = self.client.get('/api/v1/catalog/pg-wines/?points=87')
        self.assertEquals(1, len(response.data))
        self.assertEquals("21e40285-cec8-417c-9a26-4f6748b7fa3a", response.data[0]['id'])
    
    def test_views_007_test_country_must_be_exact_match(self):
        response = self.client.get('/api/v1/catalog/pg-wines/?country=Frances')
        self.assertEquals(0, len(response.data))
        self.assertJSONEqual(response.content, [])
    
    def test_views_008_test_search_results_returned_in_correct_order(self):
    ...
    def test_views_009_test_search_vector_populated_on_save(self):
    ...
    def test_views_010_test_description_highlights_matched_words(self):
        response = self.client.get("/api/v1/catalog/pg-wines/?query=wine")
        self.assertEquals('A creamy <mark>wine</mark> with full Chardonnay flavors.', response.data[0]['description'])
    
    def test_views_011_test_wine_search_words_populated_on_save(self):
    ...
    def test_views_012_test_suggests_words_for_spelling_mistakes(self):
...
class ESViewTests(APITestCase):
    ...
    def test_esviews_001_test_query_matches_variety(self):
        response = self.client.get('/api/v1/catalog/es-wines/?query=Cabernet')
        self.assertEquals(1, len(response.data))
        self.assertEquals("58ba903f-85ff-45c2-9bac-6d0732544841", response.data[0]['id'])

    def test_esviews_002_test_search_results_returned_in_correct_order(self):
    ...
    def test_esviews_003_test_descriptionhighlights_matched_words(self):
    ...
    def test_esviews_004_test_suggest_words_for_spelling_mistakes(self):
